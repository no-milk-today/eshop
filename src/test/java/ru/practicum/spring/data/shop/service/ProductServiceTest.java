...
public class ProductServiceTest {
    ...
    void testGroupProducts() {
        ...
        var grouped = underTest.groupProducts(products);
    ...
    void testGetProductsWithoutSearchAndSort() {
        ...
        Page<Product> result = underTest.getProducts("", "NO", 1, 10);
    ...
    void testGetProductsWithAlphaSort() {
        ...
        Page<Product> result = underTest.getProducts("", "ALPHA", 1, 10);
        assertThat(result.getContent()).hasSize(2);
    }
    ...
    void testFindById() {
        ...
        Optional<Product> result = underTest.findById(100L);
