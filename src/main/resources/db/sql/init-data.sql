-- Truncate the orders, order_products, users, and products tables and reset identity with CASCADE
TRUNCATE TABLE orders, order_products, users, products RESTART IDENTITY CASCADE;
